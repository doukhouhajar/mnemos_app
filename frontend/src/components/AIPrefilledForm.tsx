/**
 * AI-Prefilled Memory Object Form
 * Shows AI-generated content that user can edit
 */
...
export const AIPrefilledForm: React.FC<AIPrefilledFormProps> = ({
  learningMoment,
  userId,
  aiGenerated,
  onSuccess,
  ...
  const [title, setTitle] = useState(aiGenerated.title);
  const [definition, setDefinition] = useState(aiGenerated.definition);
  const [intuition, setIntuition] = useState(aiGenerated.intuition);
  const [examples, setExamples] = useState(aiGenerated.examples.join('\n'));
  const [misconceptions, setMisconceptions] = useState(aiGenerated.common_misconceptions.join('\n'));
  const [referenceLinks, setReferenceLinks] = useState(aiGenerated.reference_links.join('\n'));
    ...
    >
      <ScrollView style={styles.scrollView} keyboardShouldPersistTaps="handled">
        <View style={styles.header}>
          <View>
            <Text style={styles.title}>AI-Generated Content</Text>
            <Text style={styles.subtitle}>Review and edit as needed</Text>
          </View>
          {onCancel && (
